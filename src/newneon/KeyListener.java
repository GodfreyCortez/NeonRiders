...
import newneon.DirectionMapper;
        ...
        switch (gameLoop.getNumOfPlayers()) //depending on the number of players we want to look at separate cases so that other people cannot take control over AI
        {
            ...
            case 2: //if there are 2 players
                ...
                if (e.getKeyCode() == KeyEvent.VK_LEFT)//left arrow   
                    {
                        if (GameLoop.p_direction[0] != 2)
                            {
                                GameLoop.p_direction[0] = 0;//the player direction is going left (0)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_RIGHT)//right arrow  
                    {
                        if (GameLoop.p_direction[0] != 0)
                            {
                                GameLoop.p_direction[0] = 2; //the direction of the player is going right(2)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_UP)//up arrow  
                    {
                        if (GameLoop.p_direction[0] != 3)
                            {
                                GameLoop.p_direction[0] = 1; //the direction of the player is going up (1)
                            }
                    }
                else if (e.getKeyCode() == KeyEvent.VK_DOWN)
                    {
                        if (GameLoop.p_direction[0] != 1)
                            {
                                GameLoop.p_direction[0] = 3; //The direction of the character is going down (3)
                            }
                    }
                ...
                if (e.getKeyCode() == KeyEvent.VK_A)//left arrow   
                    {
                        if (GameLoop.p_direction[1] != 2)
                            {
                                GameLoop.p_direction[1] = 0;//the player direction is going left (0)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_D)//right arrow  
                    {
                        if (GameLoop.p_direction[1] != 0)
                            {
                                GameLoop.p_direction[1] = 2; //the direction of the player is going right(2)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_W)//up arrow  
                    {
                        if (GameLoop.p_direction[1] != 3)
                            {
                                GameLoop.p_direction[1] = 1; //the direction of the player is going up (1)
                            }
                    }
                else if (e.getKeyCode() == KeyEvent.VK_S)
                    {
                        if (GameLoop.p_direction[1] != 1)
                            {
                                GameLoop.p_direction[1] = 3; //The direction of the character is going down (3)
                            }
                    }
                break;
            case 3: //if there are 3 players
                ...
                if (e.getKeyCode() == KeyEvent.VK_J)//left arrow   
                    {
                        if (GameLoop.p_direction[2] != 2)
                            {
                                GameLoop.p_direction[2] = 0;//the player direction is going left (0)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_L)//right arrow  
                    {
                        if (GameLoop.p_direction[2] != 0)
                            {
                                GameLoop.p_direction[2] = 2; //the direction of the player is going right(2)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_I)//up arrow  
                    {
                        if (GameLoop.p_direction[2] != 3)
                            {
                                GameLoop.p_direction[2] = 1; //the direction of the player is going up (1)
                            }
                    }
                else if (e.getKeyCode() == KeyEvent.VK_K)
                    {
                        if (GameLoop.p_direction[2] != 1)
                            {
                                GameLoop.p_direction[2] = 3; //The direction of the character is going down (3)
                            }
                    }
                break;
            case 4://when there are 4 players
                ...
                if (e.getKeyCode() == KeyEvent.VK_NUMPAD4)//left arrow   
                    {
                        if (GameLoop.p_direction[3] != 2)
                            {
                                GameLoop.p_direction[3] = 0;//the player direction is going left (0)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_NUMPAD6)//right arrow  
                    {
                        if (GameLoop.p_direction[3] != 0)
                            {
                                GameLoop.p_direction[3] = 2; //the direction of the player is going right(2)
                            }
                    }
                if (e.getKeyCode() == KeyEvent.VK_NUMPAD8)//up arrow  
                    {
                        if (GameLoop.p_direction[3] != 3)
                            {
                                GameLoop.p_direction[3] = 1; //the direction of the player is going up (1)
                            }
                    }
                else if (e.getKeyCode() == KeyEvent.VK_NUMPAD5)//down arroe
                    {
                        if (GameLoop.p_direction[3] != 1)
                            {
                                GameLoop.p_direction[3] = 3; //The direction of the character is going down (3)
                            }
                    }                
                break;
